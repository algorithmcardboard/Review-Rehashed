...
public class SearchController {
	...
	public ResponseEntity<String> search(@RequestParam(name = "feature") String feature,
		...
		for (Document doc : results) {
			...
			b.addAsin(doc.get(HTMLParser.ASIN)).addProductTitle(doc.get(HTMLParser.PRODUCT_TITLE))
					...
					.addProductURL(doc.get(HTMLParser.PRODUCT_URL)).addReviewContent(doc.get(HTMLParser.REVIEW_CONTENT))
					...
					.addFormattedReview(doc.get(HTMLParser.FORMATTED_REVIEW_CONTENT)).build();
